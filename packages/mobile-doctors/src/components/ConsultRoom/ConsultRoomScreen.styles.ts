...
export const ConsultRoomScreenStyles = StyleSheet.create({
  ...
  joinSubContainer: { margin: 20, marginBottom: isIphoneX() ? 40 : 20 },
  joinMinimizeIconContainer: { alignItems: 'flex-end', margin: 1, marginBottom: 4 },
  joinTextContainer: {
    flexDirection: 'row',
    marginBottom: 20,
    marginRight: 18,
  ...
  joinDisplayTextStyle: {
    flex: 1,
    marginLeft: 10,
    ...theme.viewStyles.text('M', 14, theme.colors.SHARP_BLUE),
  },
  joinButtonContainer: { alignSelf: 'flex-end' },
  joinButtonStyle: { width: undefined, paddingHorizontal: 21 },
  joinFloatingButtonContainer: {
    backgroundColor: theme.colors.APP_YELLOW,
    width: 80,
    height: 80,
    borderRadius: 40,
