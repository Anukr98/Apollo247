...
export interface GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_caseSheetDetails_appointment {
  ...
  appointmentDocuments:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_caseSheetDetails_appointment_appointmentDocuments | null)[]
    | null;
  status: STATUS;
...
export interface GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_patientDetails {
  ...
  firstName: string | null;
  familyHistory:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_patientDetails_familyHistory | null)[]
    | null;
  gender: Gender | null;
  healthVault:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_patientDetails_healthVault | null)[]
    | null;
  id: string;
  lastName: string | null;
  lifeStyle:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_patientDetails_lifeStyle | null)[]
    | null;
  mobileNumber: string | null;
  patientAddress:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_patientDetails_patientAddress | null)[]
    | null;
...
export interface GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments_caseSheet {
  ...
  diagnosis:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments_caseSheet_diagnosis | null)[]
    | null;
  diagnosticPrescription:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments_caseSheet_diagnosticPrescription | null)[]
    | null;
  symptoms:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments_caseSheet_symptoms | null)[]
    | null;
  followUpDate: any | null;
  followUpAfterInDays: string | null;
  followUp: boolean | null;
  medicinePrescription:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments_caseSheet_medicinePrescription | null)[]
    | null;
  otherInstructions:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments_caseSheet_otherInstructions | null)[]
    | null;
}
...
export interface GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet {
  ...
  pastAppointments:
    | (GetJuniorDoctorCaseSheet_getJuniorDoctorCaseSheet_pastAppointments | null)[]
    | null;
