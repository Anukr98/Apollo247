...
export interface GetDoctorAppointments_getDoctorAppointments_appointmentsHistory_caseSheet {
  ...
  symptoms:
    | (GetDoctorAppointments_getDoctorAppointments_appointmentsHistory_caseSheet_symptoms | null)[]
    | null;
  status: string | null;
...
export interface GetDoctorAppointments_getDoctorAppointments_appointmentsHistory {
  ...
  caseSheet:
    | (GetDoctorAppointments_getDoctorAppointments_appointmentsHistory_caseSheet | null)[]
    | null;
...
export interface GetDoctorAppointments_getDoctorAppointments {
  ...
  appointmentsHistory:
    | (GetDoctorAppointments_getDoctorAppointments_appointmentsHistory | null)[]
    | null;
