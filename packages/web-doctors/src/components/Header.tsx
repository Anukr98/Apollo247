...
export const Header: React.FC = props => {
  ...
  const isJuniorDoctor =
    useAuth() && currentUserType === LoggedInUserType.JUNIOR;
  const isAdminDoctor =
    useAuth() && currentUserType === LoggedInUserType.JDADMIN;
  const isSecretary =
    useAuth() && currentUserType === LoggedInUserType.SECRETARY;
            ...
            Notification.requestPermission()
              ...
              .catch(function (err) {
                const logObject = {
                  ...
                  error:
                    "Error occuered in Notification Request Permissio in catch block"
                };
                sessionClient.notify(JSON.stringify(logObject));
                console.error(err);
              });
    ...
    <header className={classes.header}>
      ...
      <div className={classes.container}>
        ...
        {isSignedIn &&
          ...
          !window.location.href.includes("/patientlogdetailspage") && (
            <Navigation />
          )}
