...
export const CallPopover: React.FC<CallPopoverProps> = (props) => {
  ...
  const showCallMoreBtns = (props.appointmentStatus === 'COMPLETED' && props.sentToPatient === false && (isClickedOnPriview || props.sentToPatient === false) && !isClickedOnEdit) ? true : false;
