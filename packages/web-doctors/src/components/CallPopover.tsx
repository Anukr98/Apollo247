...
export const CallPopover: React.FC<CallPopoverProps> = props => {
  ...
  let srDoctorId;
  if (currentDoctor) {
    isSeniorDoctor = currentDoctor.doctorType !== DoctorType.JUNIOR;
    srDoctorId = currentDoctor.id;
  }
      ...
      client
        ...
        .then(_data => {
          ...
          const reschduleObject: any = {
            appointmentId: props.appointmentId,
            transferDateTime: _data!.data!.initiateRescheduleAppointment!
              .rescheduleAppointment!.rescheduledDateTime,
            doctorId: props.doctorId,
            reschduleCount: _data!.data!.initiateRescheduleAppointment!
              .rescheduleCount,
            reschduleId: _data!.data!.initiateRescheduleAppointment!
