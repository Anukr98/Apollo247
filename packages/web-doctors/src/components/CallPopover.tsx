...
export const CallPopover: React.FC<CallPopoverProps> = (props) => {
  ...
  const checkForEmptyFields = () => {
    ...
    else if (!vitalIgnored && (heightValue.trim() === '' || weightValue.trim() === '')) {
      if (vitalIgnored) {
        setVitalError({
          height: '',
          weight: '',
  ...
  const onEndConuslt = () => {
    ...
    const isEmptyFields = medicationHistory.trim() === '' ||
      (referralSpecialtyName && referralDescription.trim() === '');
        ...
        <Paper className={`${classes.modalBoxConsult} ${classes.modalBoxVital}`}>
          ...
          <div className={`${classes.tabBody} ${classes.tabBodypadding}`}>
            ...
            <div className={classes.okButtonWrapper}>
              <Button className={classes.okButton} onClick={() => { onEndConuslt() }}>
                Continue
              </Button>
