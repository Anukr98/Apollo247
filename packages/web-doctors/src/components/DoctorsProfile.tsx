...
export const DoctorsProfile: React.FC<DoctorsProfileProps> = props => {
  ...
  if (data && data.getDoctorProfile) {
    console.log(data.getDoctorProfile.city);
  }
    ...
    <div className={classes.profile}>
      ...
      <div className={classes.container}>
        <div className={classes.tabHeading}>
          ...
          <p>
            It’s great to have you join us! <br /> Here’s what your patients see
        ...
        {value === 0 && (
          <TabContainer>
            {!!data.getDoctorProfile && <DoctorProfileTab values={data.getDoctorProfile} key={1} />}
          </TabContainer>
        )}
        {value === 1 && (
          <TabContainer>
        ...
        {value === 2 && (
          <TabContainer>
            {!!data.getDoctorProfile && <FeesTab key={3} />}
          </TabContainer>
        )}
      </div>
    </div>
