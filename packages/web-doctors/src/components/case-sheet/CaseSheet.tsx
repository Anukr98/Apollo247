...
export const CaseSheet: React.FC<CashSheetProps> = (props) => {
  ...
  const items = [
    { key: 'symptoms', value: 'Symptoms', state: symptoms },
    { key: 'lifestyle', value: 'Patient History & Lifestyle', state: lifestyle },
    { key: 'healthVault', value: 'Patient Health Vault', state: healthVault },
    { key: 'note', value: "Junior Doctor's Notes", state: note },
    { key: 'diagnosis', value: 'Diagnosis', state: diagnosis },
    {
    ...
    { key: 'followup', value: 'Follow up', state: followUp },
    {
