...
export enum CleverTapEventName {
  ...
  PHR_CLICK_VACCINATION_REPORT = 'PHR Click Vaccination Report',
  PHR_CLICK_CLINICAL_DOCUMENT = 'PHR Click Clinical Documents',
  ...
  PHR_UPDATE_CLINICAL_DOCUMENT = 'PHR Update Clinical Document',
  ...
  PHR_DELETE_CLINICAL_DOCUMENT = 'PHR Delete Clinical Document',
