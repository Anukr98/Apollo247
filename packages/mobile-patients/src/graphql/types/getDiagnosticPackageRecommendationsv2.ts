...
import { DiagnosticItemType } from "./globalTypes";
...
export interface getDiagnosticPackageRecommendationsv2_getDiagnosticPackageRecommendationsv2_packageRecommendations_diagnosticInclusions_observations {
  ...
  export interface getDiagnosticPackageRecommendationsv2_getDiagnosticPackageRecommendationsv2 {
    __typename: "getDiagnosticPackageRecommendationsv2Result";
  ...
  export interface getDiagnosticPackageRecommendationsv2Variables_getDiagnosticPackageRecommendationsv2Variables {
    itemId: number, 
    itemType: DiagnosticItemType
  }
  
  export interface getDiagnosticPackageRecommendationsv2Variables {
    recommendationInputItems: getDiagnosticPackageRecommendationsv2Variables_getDiagnosticPackageRecommendationsv2Variables;
    cityId: number;
  }
