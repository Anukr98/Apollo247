...
export interface FilterDoctorInput {
  ...
  specialistPluralTerm?: (string | null)[] | null;
...
export interface ReturnPharmaOrderInput {
  ...
  email: string;
  orderId?: number | null;
  orderType?: PHARMACY_ORDER_TYPE | null;
...
export interface SaveBookHomeCollectionOrderInputv2 {
  ...
  collectionCharges: phleboCharges;
...
export interface patientObjWithLineItems {
  patientID: string;
  lineItems?: (diagnosticLineItem | null)[] | null;
  totalPrice: number;
}
...
export enum TRUECALLER_FAILURE {
  ERROR_TYPE_INTERNAL = "ERROR_TYPE_INTERNAL",
  ERROR_TYPE_NETWORK = "ERROR_TYPE_NETWORK",
  ERROR_TYPE_USER_DENIED = "ERROR_TYPE_USER_DENIED",
  ERROR_TYPE_UNAUTHORIZED_PARTNER = "ERROR_TYPE_UNAUTHORIZED_PARTNER",
  ERROR_TYPE_UNAUTHORIZED_USER = "ERROR_TYPE_UNAUTHORIZED_USER",
  ERROR_TYPE_TRUECALLER_CLOSED_UNEXPECTEDLY = "ERROR_TYPE_TRUECALLER_CLOSED_UNEXPECTEDLY",
  ERROR_TYPE_TRUESDK_TOO_OLD = "ERROR_TYPE_TRUESDK_TOO_OLD",
  ERROR_TYPE_POSSIBLE_REQ_CODE_COLLISION = "ERROR_TYPE_POSSIBLE_REQ_CODE_COLLISION",
  ERROR_TYPE_RESPONSE_SIGNATURE_MISSMATCH = "ERROR_TYPE_RESPONSE_SIGNATURE_MISSMATCH",
  ERROR_TYPE_REQUEST_NONCE_MISSMATCH = "ERROR_TYPE_REQUEST_NONCE_MISSMATCH",
  ERROR_TYPE_INVALID_ACCOUNT_STATE = "ERROR_TYPE_INVALID_ACCOUNT_STATE",
  ERROR_TYPE_TC_NOT_INSTALLED = "ERROR_TYPE_TC_NOT_INSTALLED",
  ERROR_TYPE_ACTIVITY_NOT_FOUND = "ERROR_TYPE_ACTIVITY_NOT_FOUND"
}

export interface TruecallerFailure {
  error: TRUECALLER_FAILURE
}
