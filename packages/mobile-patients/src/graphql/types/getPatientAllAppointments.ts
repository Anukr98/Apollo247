...
export interface getPatientAllAppointments_getPatientAllAppointments_activeAppointments_doctorInfo {
  ...
  specialty: getPatientAllAppointments_getPatientAllAppointments_activeAppointments_doctorInfo_specialty;
...
export interface getPatientAllAppointments_getPatientAllAppointments_followUpAppointments_doctorInfo {
  ...
  specialty: getPatientAllAppointments_getPatientAllAppointments_followUpAppointments_doctorInfo_specialty;
