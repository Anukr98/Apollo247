import { Mascot, Down, Up, HelpDrop } from '@aph/mobile-patients/src/components/ui/Icons';
...
export const MobileHelp: React.FC<CardProps> = (props) => {
  ...
  return (
    <View style={[styles.cardContainer, props.cardContainer]}>
      ...
      <View style={{ flexDirection: 'column', marginBottom: 15 }}>
        <Text style={{ ...theme.fonts.IBMPlexSansSemiBold(18), color: '#02475b', marginLeft: 20 }}>
          Hi! :)
        </Text>
        <Text
          style={{
            ...
            <View style={{ marginBottom: 30, marginLeft: 20, marginRight: 20 }}>
              <TouchableOpacity>
                ...
                >
                  ...
                  <View style={{ alignItems: 'flex-end', alignSelf: 'flex-end', marginBottom: 5 }}>
                    {!isDropdownOpen ? <HelpDrop /> : <HelpDrop />}
                  </View>
                </View>
              </TouchableOpacity>
              <View
        ...
        <View style={styles.footerButtonsContainer}>
          ...
          />
          <Button title="SUBMIT" style={styles.buttonsaveStyle} />
        </View>
      </View>
    </View>
  );
