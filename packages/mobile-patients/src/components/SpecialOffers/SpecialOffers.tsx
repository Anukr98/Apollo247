...
import { DealsByCategorySection } from './Components/DealsByCategorySection';
import { DealsByBrandsSection } from './Components/DealsByBrandsSection';
import { HotSellersSection } from './Components/HotSellersSection';
...
export const SpecialOffersScreen: React.FC<SpecialOffersScreenProps> = (props) => {
    ...
    const [widgetArray, setWidgetArray] = useState(['Carousel Banner', 'Offers', 'Top Deals on Brands', 'Offers for you', 'Deals by Category']);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                {widgetArray.map((widget) => {
                    switch(widget) {
                        case 'Carousel Banner' : { return medicineHomeBannerData ? <BannerSection navigation={props.navigation} /> : null};
                        break;
                        case 'Offers' : { return offersData ? <CouponsSection offersData={offersData.response} /> : null};
                        break;
                        case 'Deals by Category' : {return categoryData ? <DealsByCategorySection categoryData={categoryData} navigation={props.navigation} /> : null};
                        break;
                        case 'Top Deals on Brands' : { return brandsData ? <DealsByBrandsSection brandsData={brandsData} navigation={props.navigation} /> : null};
                        break;
                        case 'Offers for you' : {return medicineHotSellersData ? <HotSellersSection navigation={props.navigation} /> : null};
                        break;
                        default: null;
                    }
                })}
