...
import { getDiscountPercentage, getMaxQtyForMedicineItem, productsThumbnailUrl } from '@aph/mobile-patients/src/helpers/helperFunctions';
...
import { addPharmaItemToCart, getIsMedicine } from '@aph/mobile-patients/src/helpers/helperFunctions';
