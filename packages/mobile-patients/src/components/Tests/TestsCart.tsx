...
import { pinCodeServiceabilityApi, searchPickupStoresApi } from '@aph/mobile-patients/src/helpers/apiCalls';
...
export const TestsCart: React.FC<TestsCartProps> = (props) => {
    ...
    const tabs = [{ title: 'Home Visit', subtitle: 'Appointment Slot' }, { title: 'Clinic Visit', subtitle: 'Clinic Hours' }];
