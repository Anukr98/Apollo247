...
export const TestsCart: React.FC<TestsCartProps> = (props) => {
  ...
  const [slotsWithArea, setSlotsWithArea] = useState<TestSlotWithArea[]>([]);
  const [selectedTimeSlot, setselectedTimeSlot] = useState<TestSlot>();
  const [selectedTimeSlotWithArea, setselectedTimeSlotWithArea] = useState<TestSlotWithArea[]>([]);
  ...
  const checkSlotSelection = (item: object) => {
    client
      ...
      .then(({ data }) => {
        ...
        const slotsArray: TestSlotWithArea[] = [];
        ...
        setSlotsWithArea(slotsArray);
        slotsArray.length && setselectedTimeSlotWithArea(slotsArray);
      ...
      .catch((e) => {
        console.log('error in diagnostics slotsss' + e);
      });
  };
