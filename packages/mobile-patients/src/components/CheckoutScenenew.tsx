...
export const CheckoutSceneNew: React.FC<CheckoutSceneNewProps> = (props) => {
  ...
  const postwebEngageCheckoutCompletedEvent = (orderAutoId: string, orderId: string, isCOD?: boolean) => {
  ...
  const placeOrder = (orderId: string, orderAutoId: number, isCOD?: boolean) => {
