...
#ifndef APOLLOVITALSFRAMEWORK_SWIFT_H
#define APOLLOVITALSFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ApolloVitalsFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class ChartAxisBase;

SWIFT_CLASS("_TtC21ApolloVitalsFramework20AVDateValueFormatter")
@interface AVDateValueFormatter : NSObject <IChartAxisValueFormatter>
...
SWIFT_CLASS("_TtC21ApolloVitalsFramework20AVHomeViewController")
@interface AVHomeViewController : UIViewController <CLLocationManagerDelegate, UITableViewDataSource, UITableViewDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC21ApolloVitalsFramework19LearnViewController")
...
SWIFT_CLASS("_TtC21ApolloVitalsFramework21PaymentViewController")
