    ...
    <div className={classes.root}>
      ...
      <div className={classes.container}>
        <div className={classes.pageContainer}>
          ...
          <p>
            This Privacy Policy governs how we, [insert name of NewCo]
            (collectively, &ldquo;
            <strong>[Initials of NewCo]</strong>&rdquo;, &ldquo;
            <strong>Apollo</strong>&rdquo;, &ldquo;<strong>Company</strong>
            &rdquo;, &ldquo;<strong>we</strong>,&rdquo; &ldquo;
            <strong>us</strong>,&rdquo; or &ldquo;<strong>our</strong>&rdquo;)
            collect, use, share and process your information, that you provide
            to us through your use of the app, Apollo247 and Website [insert
            website link] in the course of providing services (&ldquo;
            <strong>Services</strong>&rdquo;) as defined in the Terms and
            Conditions [insert link for terms and conditions] to you.
          </p>
          <p>
            [Initials of NewCo], owner of the Apollo247 website and app (&ldquo;
            <strong>Website</strong>&rdquo; / &ldquo;<strong>App</strong>&rdquo;
            respectively), respects your privacy, and seeks to comply with
            applicable legal requirements in respect of data collection,
            processing and transfer.
          </p>
          <p>
            Please read this Privacy Policy carefully. By accessing or using
            this website / app, you agree to be bound by the terms described
            herein and all the terms incorporated by reference. If you do not
            agree to all of these terms, do not use this website / app.
          </p>
          <ol>
            <li>
              <strong>
          ...
          <p>
            &ldquo;Sensitive Personal Data or Information&rdquo; means Personal
            ...
            biometric information; any detail relating to the above as provided
            to or received by Apollo247 for processing or storage. However, any
            data/ information relating to an individual that is freely available
            or accessible in public domain or furnished under the Right to
            Information Act, 2005 or any other law shall not qualify as
            Sensitive Personal Data or Information.
          </p>
          <p>
            By clicking "I accept" when downloading the App or proceeding to the
            Website, and/or using our services you represent that you
            ...
            represent that you are duly authorised by any third party (including
            a child or an employer) whose information you share with us. We
            shall act as per your representation of authority and shall not make
            any independent enquiries to ascertain the veracity of your
            authorisation. In the event you do not have sufficient authorisation
            you shall be solely responsible for your acts and omissions
            including sharing of information with us by you and the
            consequential processing and actions taken by us in accordance with
            this Privacy Policy.
          </p>
          <ol start={2}>
            <li>
          ...
          <p>
            Apollo247, like many other websites uses &ldquo;Cookies&rdquo;.
            Cookies are small data files that a website stores on your web
            browser. These are used for the purpose of storing your preferences,
            previous activities browsing activities, profiling and tracking
            behaviour on this Website. By visiting Apollo247, you acknowledge,
          ...
          <p>
            When you sign up or register on the Apollo247 App or Website to use
            our Services, and during the course of actual usage of our Services,
            the types of information that will be collected by us include the
            following:
          </p>
          <ul>
            <li>
          ...
          <ul>
            <li>
              ...
              chat and other modes of communication;
            </li>
            <li>
              Information that we collect from healthcare service provider
              (HSPs) such as doctors, hospitals, diagnostic centres, chemists
              etc. in the Apollo Group, to whom you have permitted the sharing
          ...
          <ul>
            ...
            <li>
              ...
              us on call or chat and other modes of communication;
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              For the purpose of contacting you to provide you with information
              on new Services and offers, taking feedback, assisting you with
            ...
            <li>
              ...
              use of the Services offered by Apollo247 on Website/app;
            </li>
            <li>
              Carrying out our obligations in relation to any agreement with our
            ...
            <li>
              ...
              offered by Apollo247 or by its business partners), new features or
              products both of the Apollo as well as third-party offers or
              products with whom Apollo247 has a tie-up;
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              For sharing with your chosen HSP in the Apollo Group like doctors,
              hospitals, diagnostic centres, chemists who may provide you
              services under the Apollo247 Platform.
            </li>
          ...
          <p>
            We may disclose and in some cases transfer your personal information
            to such entities as required to provide services to you and to
            ...
            security measures as what we would adopt. An indicative list of
            entities we may disclose or transfer information to, are provided
            below:
          </p>
          <ol>
            <li>
              <strong>Service Providers</strong>: We share personal information
              with companies that provide Services on our behalf, such as
              website hosting, data storage, software services, email services,
              marketing, fulfilling customer orders, providing payment services,
              data analytics, data mining, providing customer services, and
              conducting surveys. These companies may be located within or
          ...
          <p>
            ...
            consultants, business partners and technology partners on a need to
            know basis. Such entities would be contractually obligated to
            maintain confidentiality in relation to your data.
          </p>
          <p>
          ...
          <ol>
            <li>
              <strong>Business Affiliates</strong>: We may disclose or transfer
              some of your information to entities in the Apollo Group,
              affiliates, associates, subsidiary, holding company of the
              Company, associates and subsidiary of holding company of the
          ...
          <ol>
            <li>
              <strong>Law Enforcement Agencies</strong>: We may share
              information with law enforcement agencies pursuant to lawful
              requests for information, and otherwise as required under any law
              applicable at the given time, both in India and outside India.
            </li>
          </ol>
          <ol>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              shared with advertisers, research firms and other partners.
            </li>
          </ul>
          <ol start={7}>
            <li>
          ...
          <p>
            We are committed towards maintaining the privacy of the information
            uploaded by you on the website and complies with the industry
            standard security safeguards for the purpose of securing the website
            and the information provided/uploaded by you.
          </p>
          <p>
            We use reasonable technical, administrative, and physical security
            measures for the purpose of safeguarding all data you share with us.
            ...
            that third parties we share data with also adopt reasonable level of
            security practices and procedures to ensure the privacy and security
            of your information.
          </p>
          <p>
          ...
          <p>
            ...
            Further, you are liable to indemnify the Company as per the Terms of
            Use.
          </p>
          <ol start={8}>
            <li>
          ...
          <p>
            ...
            or in case you wish to discontinue the use of our services. You have
          ...
          <ul>
            ...
            <li>
              You are free to not to share any medical or other information that
              you consider confidential and withdraw consent for us to use data
              that you have already provided. In the event that you refuse to
              share any information or withdraw consent to process information
              that you have previously given to us, we reserve the right to
              restrict or deny the provision of our services for which we
              consider such information to be necessary.
            </li>
            <li>
              You may contact [please insert details of Grievance Officer] for
              any questions or for exercise of these rights.
            </li>
          </ul>
          <p>Address:</p>
          ...
          <p>
            ...
            third party website or service at your own risk and the Company will
            not be held liable for any outcome or harm arising as a result of
            your use of such third party websites or services. Please read the
            privacy policies of any third party before proceeding to use their
          ...
          <p>
            ...
            continued use of our products and services after the effective date
            of the Privacy Policy means that you accept the revised Privacy
            Policy. If you do not agree with any such revised terms, please
            refrain from using our Services and&nbsp;contact us to close any
            account you may have created.
          </p>
          <p>
            The Rubix Cube is is not the only twisty puzzle. Learn about
            Pyraminx, the 2x2 and 4x4 cubes, the Megaminx on{" "}
            <a href="https://ruwix.com/">Ruwix.com</a>.
          </p>
        </div>
      </div>
      <BottomLinks />
