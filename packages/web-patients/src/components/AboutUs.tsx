    ...
    <div className={classes.root}>
      ...
      <div className={classes.container}>
        <div className={classes.aboutUs}>
          ...
          <div className={classes.headerSubText}>know more about us, we are more than a hospital…</div>
        </div>
          ...
          <div className={classes.bodyPart}>
            ...
            <div className={classes.bodyText}>
              <p className={classes.content}>
                ...
                Apollo Hospitals is acclaimed for pioneering the private healthcare revolution in the
                country.
            </p>
              <p className={classes.content}>
                ...
                E-Learning, Colleges of Nursing and Hospital Management and a Research Foundation. In
                addition, ‘ASK Apollo’ - an online consultation portal and Apollo Home Health provide
                the care continuum.
            </p>
              <p className={classes.content}>
