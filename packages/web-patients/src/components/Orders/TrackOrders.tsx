...
export const TrackOrders: React.FC<TrackOrdersProps> = props => {
  ...
  const [
    moreActionsDialog,
    setMoreActionsDialog
  ] = React.useState<null | HTMLElement>(null);
  const [isCancelOrderDialogOpen, setIsCancelOrderDialogOpen] = React.useState<
    boolean
  >(false);

  const [isReturnOrderDialogOpen, setIsReturnOrderDialogOpen] = React.useState<
    boolean
  >(false);
