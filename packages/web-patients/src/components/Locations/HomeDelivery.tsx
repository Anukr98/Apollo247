...
export const HomeDelivery: React.FC<HomeDeliveryProps> = (props) => {
  ...
  const checkLatLongStateCodeAvailability = (address: Address) => {
    const googleMapApi = `https://maps.googleapis.com/maps/api/geocode/json?address=pincode:${address.zipcode}&components=country:in&key=${process.env.GOOGLE_API_KEY}`;
