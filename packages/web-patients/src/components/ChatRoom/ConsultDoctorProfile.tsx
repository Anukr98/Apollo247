...
export const ConsultDoctorProfile: React.FC<
  ConsultDoctorProfileProps
> = props => {
      ...
      <div className={classes.doctorProfile}>
        ...
        <div className={classes.doctorInfo}>
          ...
          <div className={classes.specialits}>
            {speciality} <span className={classes.lineDivider}>|</span>{" "}
            {experience}
            ...
            <div
              ...
              onClick={e => {
                ...
                setMoreOrLessMessage(
                  currentMoreOrLessMessage === "MORE" ? "LESS" : "MORE"
                );
              }}
            >
              {moreOrLessMessage}
          ...
          >
            <div className={showMore ? classes.hideMore : ""}>
              ...
              <div
                className={`${classes.doctorInfoGroup} ${classes.opacityMobile}`}
              >
                <div className={classes.infoRow}>
                  <div className={classes.iconType}>
              ...
              <div
                className={`${classes.doctorInfoGroup} ${classes.consultDoctorInfoGroup}`}
              >
              ...
              {appointmentDetails ? (
                <div className={classes.appointmentDetails}>
                  ...
                  <div
                    className={`${classes.doctorInfoGroup} ${classes.noBorder}`}
                  >
                    <div className={`${classes.infoRow} ${classes.textCenter}`}>
                      <div className={classes.iconType}>
                        <img
                          src={require("images/ic_calendar_show.svg")}
                          alt=""
                        />
                      </div>
                      <div className={classes.details}>
                  ...
                  <div className={classes.consultGroup}>
                    <div className={classes.infoRow}>
                      ...
                      <div className={classes.details}>
                        ...
                        <br />
                        {/* <div className={classes.doctorPriceIn}>Rs. 299</div> */}
                        <AphButton className={classes.invoiceBtn}>
                          Download Invoice
                        </AphButton>
                      </div>
                      <div className={classes.doctorPrice}>
