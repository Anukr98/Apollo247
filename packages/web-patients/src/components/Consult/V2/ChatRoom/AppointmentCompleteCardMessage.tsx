...
interface AppointmentCompleteCardMessageProps {
  doctorName: string;
  messageDate: string;
}

export const AppointmentCompleteCardMessage: React.FC<AppointmentCompleteCardMessageProps> = (
  props
) => {
  ...
  return (
    <div className={classes.doctorCardMain}>
      ...
      <div className={`${classes.blueBubble} ${classes.petient} `}>
        Please wait while {props.doctorName} is preparing your prescription. The prescription will
        be sent here in the consult room itself. However, this might take a while!
