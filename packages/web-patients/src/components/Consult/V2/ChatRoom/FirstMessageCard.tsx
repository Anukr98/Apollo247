...
export const FirstMessageCard: React.FC<FirstMessageCardProps> = (props) => {
  ...
  return (
    <div className={classes.doctorCardMain}>
      ...
      <div className={`${classes.blueBubble} ${classes.petient} `}>
        Hi {props.patientName}, sorry to keep you waiting. {props.doctorName}'s team is with another
        patient right now. Your consultation prep will start soon.
