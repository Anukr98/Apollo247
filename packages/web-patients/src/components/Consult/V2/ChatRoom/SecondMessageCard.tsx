...
interface SecondMessageCardProps {
  doctorName: string;
  messageDate: string;
  patientName: string;
}

export const SecondMessageCard: React.FC<SecondMessageCardProps> = (props) => {
  ...
  return (
    <div className={classes.doctorCardMain}>
      ...
      <div className={`${classes.blueBubble} ${classes.petient} `}>
        Sorry, but all the members in {props.doctorName}'s team are busy right now. We will send you
        a notification as soon as they are available for collecting your details.
