...
interface ExotelMessageCardProps {
  doctorName: string;
  messageDate: string;
  exotelNumber: string;
}

export const ExotelMessageCard: React.FC<ExotelMessageCardProps> = (props) => {
  ...
  return (
    <div className={classes.doctorCardMain}>
      ...
      <div className={`${classes.blueBubble} ${classes.petient} `}>
        {props.doctorName} is trying to call you from the number {props.exotelNumber}. Request you
        to answer the call.
