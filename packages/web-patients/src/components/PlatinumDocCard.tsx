...
export const PlatinumDocCard: React.FC<PlatinumCardProps> = (props) => {
    ...
    const availabilityMarkup = (type: string) => {
        return type === 'markup' ? (
            <div
                className={`${classes.availability} ${differenceInMinutes < 15 ? classes.availableNow : null
                    }`}
            >
    ...
    return (
        <div className={classes.pdContainer}>
            ...
            <Typography className={classes.heading}> <img src={require('images/ic_doctor_consult.svg')} alt="" />Doctor of the Hour!</Typography>

            <div className={classes.pdocCard}>
                <a href="javascript: void(0);" className={classes.apolloImg}><img src={require('images/ic_apollo.svg')} /></a>
                <div className={classes.availableBox}> <Typography> {'available in ' + doctorInfo.earliestSlotInMinutes + ' mins'}</Typography></div>
                <Link to={clientRoutes.doctorDetails(readableParam(doctorValue), doctorInfo.id)}>
                    <div className={classes.pdocContent}>
                        <div className={classes.pdDocImgContainer}>
                            <div className={classes.imgBox}><img src={doctorInfo.photoUrl} alt="" width="100px" /></div>
                            <div className={classes.pdocConnectOptions}>
                                {/* {props.consultMode}    */}
                                <ul className={classes.consultModes}>
                                    <li><img src={require('images/ic-video.svg')} /><Typography> Online</Typography> </li>
                                    <li><img src={require('images/fa-solid-hospital.svg')} /> <Typography>In Person</Typography></li>
                                </ul>
                            </div>
                        </div>
                        <div className={classes.pdocInfo}>
                            <Typography component="h2">{doctorInfo.displayName}</Typography>
                            <Typography component="h3">  {doctorInfo.specialtydisplayName} |  <span>{doctorInfo.experience + 'years'}</span> </Typography>
                ...
                <div className={classes.consultDetails}>
                    <Typography>Consultation Fees: <span> ₹ {doctorInfo.fee}</span></Typography>
