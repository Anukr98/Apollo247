                  ...
                  <div className={classes.detailsContent}>
                    <ul className={classes.tncList}>
                      <li>
                        ...
                        customers.
                        <li>
                          The validity of membership is 1 year and the validity of program (“Term”)
                          is till 30th September 2021, unless extended by Apollo 24|7 and HDFC Bank
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          customers and offerings will vary with the different categories of
                          accounts of HDFC customers. However, membership schemes can be upgraded /
                          downgraded on the basis of the spending on the Apollo 24|7 app or web as
                          mentioned in the offer grid.{' '}
                        </li>
                        <li>
                          The HealthyLife Program is open to all HDFC current and saving accounts
                          customers with a valid Indian mobile number registered with HDFC bank
                          only.{' '}
                        </li>
                        <li>
                          The T&amp;C’s of the OneApollo silver, gold and platinum membership
                          offered in the HealthyLife program shall be governed by the terms &amp;
                        ...
                        <li>
                          ...
                          Account holders of HDFC Bank, whether they are existing customers of
                          Apollo 24|7 or not. However, all the customers shall adhere to the terms
                          and conditions as mentioned in this marketing program.{' '}
                        </li>
                        ...
                        <li>
                          By enrolling for the HealthyLife program, a member consents to allow use
                          and disclosure by Apollo Health centres,of his/her personal and other
                        ...
                        <li>
                          Benefits and offers available through the program may change or be
                          withdrawn without prior intimation. Apollo 24|7 will not be responsible
                          for any liability arising from such situations or use of such offers.
                        </li>
                        <li>
                          ...
                          and Conciliation Act, 1996. The place of arbitration shall be at Chennai
                          and language of arbitration shall be English. The existence of a dispute,
                          if at all, shall not constitute a claim against Apollo 24|7.
                        </li>
                      </li>
                    </ul>
                  </div>
