...
export const Faq: React.FC = (props) => {
  ...
  const metaTagProps = {
    ...
    desciption: "FAQs on doctors, medicines, and more on Apollo 247 - India's online pharmacy store. Have all your questions answered at one place. Visit FAQs by Apollo 247 to get your answer today!",
