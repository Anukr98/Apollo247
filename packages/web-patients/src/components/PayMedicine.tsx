...
export const PayMedicine: React.FC = (props) => {
    ...
    const { cartTotal, deliveryAddressId, prescriptions, ePrescriptionData, cartItems } = useShoppingCart();
    ...
    useEffect(() => {
        fetchUtil(`https://aph.dev.pmt.popcornapps.com/list-of-payment-methods`, 'GET', {}, '', true).then((res: any) => {
            if (res) {
        ...
        SAVE_MEDICINE_ORDER,
        {
            variables: {
                medicineCartInput: {
                    ...
                    orderTat: deliveryAddressId && moment('15-May-2020 20:00').isValid() ? '15-May-2020 20:00' : '',
        ...
        <div className={classes.root}>
            ...
            <div className={classes.container}>
                <div className={classes.payMedicineContainer}>
                    ...
                    <div className={`${classes.charges} ${classes.chargesMobile}`}> <p>Amount To Pay</p><p>Rs.{cartTotal}</p></div>
                    <Grid container spacing={2} className={classes.paymentContainer}>
                        ...
                        <Grid item xs={12} sm={4} className={classes.chargesContainer}>
                            ...
                            <Paper className={classes.paper}>
                                <div className={classes.charges}> <p>MRP Total</p> <p>Rs.{cartTotal}</p></div>
                                <div className={`${classes.charges} ${classes.discount}`}><p>Product Discount</p> <p>-Rs.{discountAmount}</p></div>
                                <div className={classes.charges}><p>Delivery Charges</p> <p>+ Rs.{deliveryCharges}</p></div>
                                <div className={classes.charges}><p>Packing Charges</p> <p>+ Rs.0</p></div>
                                <div className={`${classes.charges} ${classes.total}`}><p>To Pay</p> <p>Rs.{totalAmount}</p></div>
                            </Paper>
                        </Grid>
                    </Grid>
                </div>
