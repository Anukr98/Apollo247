								...
								<ul className={classes.usefulLinksList}>
									{topSpecialtyListing &&
										...
										topSpecialtyListing.map((specialityDetails: TopSpecialtyType, index) => {
											return (
												<li key={index}>
													<Link to={clientRoutes.specialties(readableParam(specialityDetails.slugName))}>{specialityDetails.specialtyName}</Link>
												</li>
											)
										})}
								</ul>
								...
								<ul className={classes.usefulLinksList}>
									{pharmacyLinkListing &&
										...
										pharmacyLinkListing.map((phamacyLink: TopPharmacyLinkType, index) => {
											return (
												<li key={index}>
													<Link to={clientRoutes.searchByMedicine(searchText, phamacyLink.url_key)}>{phamacyLink.title}</Link>
												</li>
											)
										})}
								</ul>
