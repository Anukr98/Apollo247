...
export class AppointmentCallFeedback extends BaseEntity {
  ...
  /* Type JSON of format - 
  {"audio":[{"responseName":"AUDIO_ECHO"},{"responseName":"OTHERS","comment":"Patient voice was muffled"}],"video":[{"responseName":"VIDEO_NOT_CLEAR"},{"responseName":"VIDEO_NOT_RECEIVED"}]} 
  */
  @Column({ nullable: true, type: 'json' })
