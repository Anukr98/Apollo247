...
//NOT USED code as confirmed with sushma, commenting it to prevent confusion
...
//           const apptDetails = await appointmentRepo.findById(apolloAppointmentResp.appointmentId.toString());
