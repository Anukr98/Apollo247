export enum ApiConstants {
  ...
  DOCTOR_BOOK_APPOINTMENT_WHATSAPP = 'https://media.smsgupshup.com/GatewayAPI/rest?method=SendMessage&send_to={3}&userid=2000191996&password=4FTAuTRZ&auth_scheme=plain&msg_type=TEXT&format=text&v=1.1&msg=Hi%20Dr.%20{0}%2C%20you%20have%20a%20new%20appointment%20for%20today.%0A%0APatient%20Name%20%3A%20{1}%0AAppointment%20Time%20%3A%20{2}%0A%0ATeam%20Apollo%2024%7C7',
